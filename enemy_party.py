...
class EnemyParty:
    ENEMIES = [Enemy(name='SYPHILIS',
                     movesets=[[Move("SYPHILIS used ULCERS! GAUNTY CRISPS' DEFENCE fell!"),
                                ...
                                Move("SYPHILIS used BLOTCHY RED RASH! It's super effective!",
               ...
               Enemy(name='THE WHEEL',
                     movesets=[[],
                               ...
                               [Move("The Wheel spins... It lands on JOAN OF ARC! JOAN OF ARC appears and instantly "
                                     "dies of SCURVY."),
                     ...
                     movesets=[[],
                               ...
                               [Move("FUNNY HEIR sips from his WIFEHOUSE MUG, available on ETSY.COM/SHOP/MORLMERCH."),
                                Move("FUNNY HEIR yells at ANDREW ELDRITCH! ANDREW ELDRITCH'S SELF ESTEEM sharply "
                                     "falls! ANDREW ELDRITCH retires to SHEFFIELD!",
                                     target_damage_fraction=1)],

                               [Move("Your horrible father, FUNNY HEIR, has frozen you! "
                                     "You're frozen solid! Ts and Hs in the chat! "
                                     "FUNNY HEIR became King of Blue Country! FUNNY HEIR'S BOURGEOISIE rose! "
                                     "You defrosted!"),
                                Move("FUNNY HEIR feels guilty about freezing the child of destiny. FUNNY HEIR'S SELF "
                                     "ESTEEM falls!"),
               ...
               Enemy(name='TWO GOATS',
                     movesets=[[],
                               ...
                               [Move("The TWO GOATS offer you some SHOWER PORRIDGE. You refuse and they begin to get "
                                     "hysterical."),
